        ...
        <div className='md:flex md:gap-8'>
          ...
          <section className='flex items-center gap-3 sm:gap-7 md:mt-8 max-sm:text-sm'>
            <Link href='orders?status=pending'>
              <h5 className={`${isActive('pending') && 'border-b-4 border-title text-title font-bold'} font-semibold`}>Pendientes</h5>
            </Link>
            <Link href='orders?status=inProccess'>
              <h5 className={`${isActive('inProccess') && 'border-b-4 border-title text-title font-bold'} font-semibold`}>En preparación</h5>
            </Link>
            <Link href='orders?status=shipping'>
              <h5 className={`${isActive('shipping') && 'border-b-4 border-title text-title font-bold'} font-semibold`}>Enviados</h5>
            </Link>
            <Link href='orders?status=received'>
              <h5 className={`${isActive('received') && 'border-b-4 border-title text-title font-bold'} font-semibold`}>Entregados</h5>
            </Link>
          </section>
        </div>
        <hr />
